...
L.StorageTileLayer = L.TileLayer.extend({
	...
	_loadTile: function (tile, tilePoint) {
		...
		var key = (this.options.continent_id ? (this.options.continent_id + ',') : '') + (this.options.map_floor ? (this.options.map_floor + ',') : '') + tilePoint.z + ',' + tilePoint.y + ',' + tilePoint.x;
