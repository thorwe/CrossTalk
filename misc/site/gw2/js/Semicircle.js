...
(function (L) {
    ...
    L.Circle = L.Circle.extend({
        ...
        startAngle: function () {
            return this._fixAngle(Math.min(this.options.startAngle, this.options.stopAngle));
        },

        stopAngle: function () {
            return this._fixAngle(Math.max(this.options.startAngle, this.options.stopAngle));
        },
        ...
        setDirection: function (direction, degrees) {
            if (degrees > 359) {
                ...
                this.options.stopAngle = degrees;
            } else {
