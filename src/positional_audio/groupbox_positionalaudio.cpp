    ...
    QGroupBox(parent)
{
    ...
    m_volume = new QGroupBox;
    {
        ...
        connect(m_distance_min, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &GroupBoxPositionalAudio::distanceMinChanged);
        ...
        connect(m_distance_max, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &GroupBoxPositionalAudio::distanceMaxChanged);
        ...
        connect(m_rolloff, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), this, &GroupBoxPositionalAudio::on_DoubleSpinBoxRollOff_valueChanged);
        ...
        connect(m_rolloff_max, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), this, &GroupBoxPositionalAudio::on_DoubleSpinBoxRollOffMax_valueChanged);
    ...
    // group box server settings
    {
        ...
        connect(groupbox_serversettings, &GroupBoxPositionalAudioServers::enabledSet, this, &GroupBoxPositionalAudio::ServerEnabledSet);
        connect(groupbox_serversettings, &GroupBoxPositionalAudioServers::sendIntervalChange, this, &GroupBoxPositionalAudio::ServerSendIntervalChange);
        connect(groupbox_serversettings, &GroupBoxPositionalAudioServers::sendIntervalSilentIncChange, this, &GroupBoxPositionalAudio::ServerSendIntervalSilentIncChange);
        connect(groupbox_serversettings, &GroupBoxPositionalAudioServers::blockedSet, this, &GroupBoxPositionalAudio::ServerBlockSet);
        connect(groupbox_serversettings, &GroupBoxPositionalAudioServers::addButtonClicked, this, &GroupBoxPositionalAudio::ServerAddButtonClicked);
        connect(groupbox_serversettings, &GroupBoxPositionalAudioServers::removeButtonClicked, this, &GroupBoxPositionalAudio::ServerRemoveButtonClicked);

        // to UI
        connect(this, &GroupBoxPositionalAudio::UpdateUIServerAdd, groupbox_serversettings, &GroupBoxPositionalAudioServers::UpdateUIServerAdd);
        connect(this, &GroupBoxPositionalAudio::UpdateUIServerRemove, groupbox_serversettings, &GroupBoxPositionalAudioServers::UpdateUIServerRemove);
        connect(this, &GroupBoxPositionalAudio::UpdateUIServerEnabled, groupbox_serversettings, &GroupBoxPositionalAudioServers::UpdateUIServerEnabled);
        connect(this, &GroupBoxPositionalAudio::UpdateUIServerBlocked, groupbox_serversettings, &GroupBoxPositionalAudioServers::UpdateUIServerBlocked);
        connect(this, &GroupBoxPositionalAudio::UpdateUIServerSendInterval, groupbox_serversettings, &GroupBoxPositionalAudioServers::UpdateUIServerSendInterval);
        connect(this, &GroupBoxPositionalAudio::UpdateUIServerSendIntervalSilentInc, groupbox_serversettings, &GroupBoxPositionalAudioServers::UpdateUIServerSendIntervalSilentInc);

        connect(this, &GroupBoxPositionalAudio::UpdateUIServerSelect, groupbox_serversettings, &GroupBoxPositionalAudioServers::UpdateUIServerSelect);
